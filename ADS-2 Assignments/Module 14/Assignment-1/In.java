...
public final class In {
    ...
    // http://weblogs.java.net/blog/pat/archive/2004
    /10/stupid_scanner_1.html
     */
    ...
    public In() {
        scanner = new Scanner(
            new BufferedInputStream(System.in), CHARSET_NAME);
    ...
    /**
     * Initializes an input stream from a given {@link Scanner}
     * source; use with
     ...
     * @throws IllegalArgumentException if {@code scanner}
     * is {@code null}
     */
    ...
    /**
      ...
      *
      * @return the next line in this input stream; {@code null}
      * if no such line
      */
